...
#Requests library
#Get the x and y data from the website to initialize the model.
...
#set the number of agents, number of iterations, and number of neighbourhood.
num_of_agents = 10
...
# Make the agents.
#Pass the agents list and environment.
...
def update(frame_number):
    ...
    for i in range(num_of_agents):
        ...
        print("coordinate x, coordinate y :",agents[i].x,agents[i].y)  #Display x,y coordinates.
